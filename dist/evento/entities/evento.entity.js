...
const asistente_entity_1 = require("../../asistente/entities/asistente.entity");
const auditorio_entity_1 = require("../../auditorio/entities/auditorio.entity");
const ponente_entity_1 = require("../../ponente/entities/ponente.entity");
...
], Evento.prototype, "duracion", void 0);
__decorate([
    (0, typeorm_1.Column)('text'),
    __metadata("design:type", String)
], Evento.prototype, "estado", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => ponente_entity_1.Ponente, (ponente) => ponente.eventos),
    __metadata("design:type", ponente_entity_1.Ponente)
], Evento.prototype, "ponente", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => asistente_entity_1.Asistente, (asistente) => asistente.evento),
    __metadata("design:type", Array)
], Evento.prototype, "asistentes", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => auditorio_entity_1.Auditorio, (auditorio) => auditorio.eventos),
